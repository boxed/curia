...
class Thread(models.Model):
    name = models.CharField(max_length=767, null=True, verbose_name=_('Name'))
    ...
    last_changed_time = models.DateTimeField(auto_now_add=True, verbose_name=_('Last changed time'))
    deleted = models.BooleanField(default=False, verbose_name=_('Deleted'))
    deleted_by = models.ForeignKey(User, blank=True, null=True, default=None, related_name="deleted_forums", verbose_name=_('Deleted by'))
    deletion_time = models.DateTimeField(blank=True, null=True, verbose_name=_('Deletion time'))
    last_changed_by = models.ForeignKey(User, related_name='messages_that_are_latest_in_threads', verbose_name=_('Last changed by'))
    number_of_replies = models.IntegerField(default=0, verbose_name=_('Number of replies'))
...
class Message(models.Model):
    ...
    parent_message = models.ForeignKey('self', null=True, blank=True, related_name='child_message', verbose_name=_('Parent message'))
    ...
    creation_time = models.DateTimeField(auto_now_add=True, verbose_name=_('Creation time'))
    deleted = models.BooleanField(default=False, verbose_name=_('Deleted'))
    deleted_by = models.ForeignKey(User, blank=True, null=True, default=None, related_name="deleted_messages", verbose_name=_('Deleted by'))
